...
public class SignupThree extends JFrame implements ActionListener {
	...
	SignupThree(String formno) {
		...
		JLabel number = new JLabel("XXXX-XXXX-XXXX-1456");
		...
		sRequired.setBounds(100, 450, 200, 30);
		add(sRequired);
		...
		c7 = new JCheckBox("[hereby decalred that the above entered details are correct tot he beat of my knowledge]");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == submit) {
			...
			if (r1.isSelected()) {
				...
				accountType = "Recurring Deposit Accoun";
			}
